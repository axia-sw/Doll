...
// notkyon-170620 - This is a modified version of glfw_config.h.in
// Autodetect build settings based on environment.
...
#ifdef _WIN32
# error "Usage of GLFW is not supported on Windows."
#endif
