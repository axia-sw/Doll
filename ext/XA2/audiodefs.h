...
#ifdef _MSC_VER
# define MSC_WARN_PUSHDISABLE(N_) \
...
#ifdef _MSC_VER
# define MSC_DECLSPEC_UUID(X_) __declspec(uuid(X_))
#else
# define MSC_DECLSPEC_UUID(X_)
#endif
...
#define GCC_WARN_PUSHDISABLE(Flag_)\
	GCC_PRAGMA(GCC diagnostic push)\
	GCC_PRAGMA(GCC diagnostic ignored Flag_)
#define GCC_WARN_POP()\
 ...
 ***************************************************************************/
    ...
    MSC_WARN_PUSHDISABLE(4200)  // Disable zero-sized array warnings
	GCC_WARN_PUSHDISABLE("-Wpedantic")
 ...
 ***************************************************************************/
        ...
        struct MSC_DECLSPEC_UUID("00000001-0000-0010-8000-00aa00389b71") KSDATAFORMAT_SUBTYPE_PCM_STRUCT;
        #define KSDATAFORMAT_SUBTYPE_PCM __uuidof(KSDATAFORMAT_SUBTYPE_PCM_STRUCT)
    #endif

    #ifndef KSDATAFORMAT_SUBTYPE_ADPCM
        struct MSC_DECLSPEC_UUID("00000002-0000-0010-8000-00aa00389b71") KSDATAFORMAT_SUBTYPE_ADPCM_STRUCT;
        #define KSDATAFORMAT_SUBTYPE_ADPCM __uuidof(KSDATAFORMAT_SUBTYPE_ADPCM_STRUCT)
    #endif

    #ifndef KSDATAFORMAT_SUBTYPE_IEEE_FLOAT
        struct MSC_DECLSPEC_UUID("00000003-0000-0010-8000-00aa00389b71") KSDATAFORMAT_SUBTYPE_IEEE_FLOAT_STRUCT;
